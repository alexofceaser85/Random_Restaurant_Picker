...
public class ErrorMessages {
	...
	public static final String RESTAURANT_ID_SHOULD_NOT_NULL = "The restaurant's id cannot be null";
	public static final String RESTAURANT_ID_SHOULD_NOT_EMPTY = "The restaurant's id cannot be empty";
}
