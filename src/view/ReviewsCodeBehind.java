...
public class ReviewsCodeBehind extends BaseCodeBehind implements Activatable {
	 ...
	 * @precondition none
	 * @postcondition none
	 * @param theReviewsManagerViewModel the viewModel for the code behind.
	 */
	...
	private void setupReviewPane() {
		...
		this.reviewPane.setStyle("-fx-background-color: #e5e5e5;" + "-fx-border-width: 2;"
