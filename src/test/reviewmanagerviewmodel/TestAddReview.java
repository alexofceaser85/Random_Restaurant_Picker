...
class TestAddReview {
	...
	public void shouldAddOneReview() {
		...
		ReviewsManagerViewModel theReviewsViewModel = new ReviewsManagerViewModel("American Pie");
		theReviewsViewModel.addReview("Alex DeCesare", "It was tremendous", 5);
		
		assertEquals("Reviewer: Alex DeCesare Content: It was tremendous Score: 5.0"
				+ System.lineSeparator(), theReviewsViewModel.toString());
	}
	...
	public void shouldAddManyReviews() {
		...
		ReviewsManagerViewModel theReviewsViewModel = new ReviewsManagerViewModel("American Pie");
		theReviewsViewModel.addReview("Alex DeCesare", "It was tremendous", 5);
		theReviewsViewModel.addReview("Alexander Ayers", "It was not tremendous", 3);
		theReviewsViewModel.addReview("Furichous Jones", "It was terrible", 1);
