...
class TestConstructor {
	...
	void testValidInputs() {
		RestaurantsQuery testQuery = new RestaurantsQuery("30117", 16090, "chinese,mexican", 4, this.testPrices, true, true, true, true, true);
	...
	void testNullLocation() {
		Assertions.assertThrows(IllegalArgumentException.class, () -> {
			new RestaurantsQuery(null, 16090, "chinese,mexican", 4, this.testPrices, true, true, true, true, true);
		});
	}
	@Test
	void testBlankLocation() {
		Assertions.assertThrows(IllegalArgumentException.class, () -> {
			new RestaurantsQuery("", 16090, "chinese,mexican", 4, this.testPrices, true, true, true, true, true);
		});
	}
	@Test
	void testNullCategories() {
		RestaurantsQuery testQuery = new RestaurantsQuery("30117", 16090, null, 4, this.testPrices, false, false, false, false, false);
	...
	void testBlankCategories() {
		RestaurantsQuery testQuery = new RestaurantsQuery("30117", 16090, "", 4, this.testPrices, false, false, false, false, false);
		assertEquals("https://api.yelp.com/v3/businesses/search?term=restaurants&location=30117&radius=16090&price=1,3",testQuery.getQueryURL().toString());
	}
	
	@Test
	void testNullPrices() {
		RestaurantsQuery testQuery = new RestaurantsQuery("30117", 16090, "chinese,mexican", 4, null, false, false, false, false, false);
	...
	void testEmptyPrices() {
		RestaurantsQuery testQuery = new RestaurantsQuery("30117", 16090, "chinese,mexican", 4, new ArrayList<Price>(), false, false, false, false, false);
		assertEquals("https://api.yelp.com/v3/businesses/search?term=restaurants&location=30117&radius=16090&categories=chinese,mexican",testQuery.getQueryURL().toString());
	}
}
